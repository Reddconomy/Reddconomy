				...
				case "deposit":{
					...
					if(addr!=null){
						if(API_QR.equalsIgnoreCase("enabled")){
							player.sendMessage(Text.of(ReddconomyApi.createQR(addr,ReddconomyApi.getInfo().coin,amount)));
					...
					if(is_admin){
						...
						switch(action){
							...
							case "deposit":{
								...
								if(addr!=null){
									if(API_QR.equalsIgnoreCase("enabled")) player.sendMessage(Text.of(ReddconomyApi.createQR(addr,ReddconomyApi.getInfo().coin,amount)));
